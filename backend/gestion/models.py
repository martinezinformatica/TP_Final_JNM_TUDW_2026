...
class Mesa(models.Model):
    ...
    cliente_telefono = models.CharField(max_length=20, blank=True, null=True, default=None)

    def __str__(self):
        estado = "Libre" if self.esta_libre else f"Ocupada por {self.cliente_telefono}"
