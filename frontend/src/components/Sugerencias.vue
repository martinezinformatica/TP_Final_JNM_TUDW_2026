  ...
  <div class="nosotros-container">
    <div class="card-horizontal-sugerencias">
      <div class="col-texto form-section">
        ...
        <p class="subtitulo">Tu opinion ayuda a mejorar la mistica.</p>
        ...
        <textarea
          ...
          placeholder="Escribi tu sugerencia aquí..."
      ...
      <div class="col-opiniones">
        <h2 class="dorado-texto">Ultimas Opiniones</h2>
...
const mandarSugerencia = () => {
  if (!calificacionSeleccionada.value)
    return alert("Por favor, selecciona una calificacion.");
  if (nuevoComentario.value.trim().length < 5)
    return alert("Escribi un comentario mas largo.");
